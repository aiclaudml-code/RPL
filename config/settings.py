...
BOOKMAKERS = {
    "fonbet": {
        ...
        "football_url": "https://www.fonbet.ru/sports/football/",
        "enabled": True,
    },
    "winline": {
        "name": "Винлайн",
        ...
        "football_url": "https://www.winline.ru/sports/football/",
        "enabled": True,
    },
    "betboom": {
        "name": "Бетбум",
        "base_url": "https://betboom.ru",
        "api_url": "https://betboom.ru/api",
        "football_url": "https://betboom.ru/sport/Football",
        "enabled": True,
    },
    "leon": {
        "name": "Леон",
        ...
        "football_url": "https://leon.ru/sports/football/",
        "enabled": True,
    },
    "betcity": {
        "name": "БетСити",
        ...
        "football_url": "https://betcity.ru/sports/football/",
        "enabled": True,
    },
    "olimpbet": {
        "name": "ОлимпБет",
        ...
        "football_url": "https://www.olimpbet.ru/football/",
        "enabled": True,
    },
    "ligastavok": {
        "name": "Лига Ставок",
        ...
        "football_url": "https://www.ligastavok.ru/sport/football/",
        "enabled": True,
    },
    "parimatch": {
        "name": "Пари Матч",
        ...
        "football_url": "https://www.parimatch.ru/ru/sport/soccer/",
        "enabled": True,
    },
    "1xstavka": {
        "name": "1хСтавка",
        ...
        "football_url": "https://1xstavka.ru/line/football/",
        "enabled": True,
    },
}
...
SEASONS = {
    "current": "2025-26",
    "available": ["2020-21", "2021-22", "2022-23", "2023-24", "2024-25", "2025-26"],
}

# ==================== СУДЬИ РПЛ 2025/2026 ====================
# Список судей, работавших в РПЛ в сезоне 2025/2026
REFEREES_2025_26 = [
    "Карасев С.",
    "Матюнин А.",
    "Безбородов А.",
...
# ==================== КОМАНДЫ РПЛ 2025/2026 ====================
# 16 команд; Химки исключены за нарушение лицензирования
# Новые команды: Акрон, Балтика, Динамо Махачкала (чемпион ФНЛ 2024/25 - Балтика)
RPL_TEAMS = {
    ...
    "Акрон":            {"city": "Тольятти",         "alias": ["Akron", "ФК Акрон"]},
    "Балтика":          {"city": "Калининград",      "alias": ["Baltika", "ФК Балтика"]},
    "Динамо Махачкала": {"city": "Махачкала",        "alias": ["Dynamo Makhachkala", "Динамо Мх"]},
}
